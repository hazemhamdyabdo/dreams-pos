        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body rangeslider rangeslider1">
...
<style>
.slider-connect {
  background: var(--slider-connect-bg, #ff9f43) !important;
  cursor: pointer;
}
...
.slider-tooltip {
  background: var(--slider-tooltip-bg, #ff9f43) !important;
  border: 1px solid var(--slider-tooltip-bg, #ff9f43) !important;
...
.rangeslider .slider-horizontal .slider-handle {
  ...
  left: calc(var(--slider-handle-width, 1px) / 2 * -1);
  top: calc(
...
.slider-txt-dir-rtl.slider-horizontal .slider-handle {
  right: calc(var(--slider-handle-width, 8px) / 2 * -1) !important;
  left: auto !important;
}
.rangeslider1 .slider-origin .slider-tooltip-top {
  right: 0% !important;
}
</style>
